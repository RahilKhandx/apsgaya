...
<!-- Mirrored from templates.hibootstrap.com/Army Public School/default/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Feb 2025 06:44:47 GMT -->
...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/images/faviconmain.png">
</head>
        ...
        <div class="mobile-responsive-nav">
            <div class="container-fluid">
                <div class="mobile-responsive-menu">
                    <div class="logo">
                        <a href="index.php">
                            <img src="assets/images/logomain.png" class="main-logo w-100" lt="logo">
                            <img src="assets/images/logomain.png" class="white-logo" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="belief.php" class="nav-link">Our Mission & Vision</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="staff.php" class="nav-link">School Managing Committee</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="curricullum.php" class="nav-link">Curriculum</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Mandatory Public Disclosure</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="index.php">
                        <img src="assets/images/logomain.png" alt="logo" class="w-100">
                    </a>
